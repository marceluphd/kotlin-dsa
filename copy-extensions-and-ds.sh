...
# echo "rm -rf $kotlin_dsa_path/$ds_path"
# echo "rm -rf $kotlin_dsa_path/$exts_path"
# echo "cp -R $leetkode_path/$src_path/$ds_path $src_path/$ds_path"
# echo "cp -R $leetkode_path/$src_path/$exts_path $src_path/$exts_path"
# echo "cp -R $leetkode_path/$test_path/$ds_path $test_path/$ds_path"
# echo "cp -R $leetkode_path/$test_path/$exts_path $test_path/$exts_path"

rm -rf "$kotlin_dsa_path/$ds_path"
rm -rf "$kotlin_dsa_path/$exts_path"
